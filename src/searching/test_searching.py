...
class SearchingTests(unittest.TestCase):
    ...
    def test_interpolation_search(self):
        arr1 = [-9, -8, -6, -4, -3, -2, 0, 1, 2, 3, 5, 7, 8, 9]
        arr2 = []
        self.assertEqual(interpolation_search(arr1, -8), 1)
        self.assertEqual(interpolation_search(arr1, 0), 6)
        self.assertEqual(interpolation_search(arr2, 6), -1)
        self.assertEqual(interpolation_search(arr2, 0), -1)
